        ...
        public class ScheduleList
        {
            ...
            public class Display
            {
                ...
                public Display(string columnKey, string columnValue, int monthStartNendo)
                {
                    ...
                    System.DateTime convertValueToDatetime(string param, bool isYear)
                    {
                        ...
                        return ComUtil.ConvertDateTimeFromYyyymmddString(convValue) ?? System.DateTime.Now;
                    }
                }
            ...
            public class GetCondition
            {
                ...
                public System.DateTime ScheduleEnd { get; set; }
                ...
                public GetCondition(Condition condition, int monthStartNendo)
                {
                    ...
                    this.ScheduleStart = new System.DateTime(condition.ScheduleStartYear, monthStartNendo, 1);
                    // 年単位 or 月単位
                    if (this.IsYear())
                    {
                        // 年単位の場合
                        this.ScheduleStart = new System.DateTime(condition.ScheduleYearFrom, monthStartNendo, 1);
                ...
                public Dictionary<string, object> ConvertScheduleLayout(string pNendoText, int pYearStartMonth, bool isMovable)
                {
                    ...
                    for (System.DateTime date = this.ScheduleStart; date <= this.ScheduleEnd; date = date.AddMonths(addMonths))
                    {
                    ...
                    // 年月日から年度を取得する処理
                    string getNendoYear(System.DateTime target)
                    {
                        // 年度開始日を取得
                        System.DateTime start = ComUtil.GetNendoStartDay(target, pYearStartMonth);
