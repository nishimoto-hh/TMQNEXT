...
namespace CommonSTDUtil.CommonDBManager
{
    public class CommonDBManager
    {
        ...
        public T GetEntity<T>(string sql, object param = null)
        {
            ...
            result = this.Connection.QueryFirstOrDefault<T>(sql, param, this.transaction);
        ...
        public dynamic GetEntity(string sql, object param = null)
        {
            ...
            result = this.Connection.QueryFirstOrDefault(sql, param, this.transaction);
        ...
        public int GetCount(string sql, object param = null)
        {
            ...
            cnt = Convert.ToInt32(this.Connection.ExecuteScalar(sql, param, transaction: this.transaction));
        ...
        public IList<T> GetList<T>(string sql, object param = null)
        {
            ...
            result = this.Connection.Query<T>(sql, param, this.transaction).ToList<T>();
        ...
        public IList<dynamic> GetList(string sql, object param = null)
        {
            ...
            result = this.Connection.Query(sql, param, this.transaction).ToList();
        ...
        public int Regist(string sql, object param = null)
        {
            ...
            return this.Connection.Execute(sql, param, transaction: this.transaction);
        }
        ...
        public T RegistAndGetKeyValue<T>(string sql, out bool isError, object param = null)
        {
            ...
            return (T)this.Connection.ExecuteScalar(sql, param, this.transaction);
        }
        ...
        public DataTable RegistAndGetKeyTable(string sql, object param = null)
        {
            ...
            var reader = this.Connection.ExecuteReader(sql, param, this.transaction);
        ...
        public int GetCountByOutsideSql(string sqlName, string subDirName = "", object param = null)
        {
            ...
            if (!string.IsNullOrEmpty(path) && File.Exists(path))
            {
                cnt = Convert.ToInt32(this.Connection.ExecuteScalarOutsideSql(path, param, this.transaction, 180));
            }
            return cnt;
        }
