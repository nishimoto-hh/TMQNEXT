  ...
  var Tooltip = /*#__PURE__*/function (_Module) {
    ...
    _createClass(Tooltip, [{
      ...
      value: function mousemoveCheck(action, e, component) {
          //UPDATE start : Error when using Nested Table  ATTS
          //var tooltip = action === "tooltip" ? component.column.definition.tooltip : component.definition.headerTooltip;
          var tooltip;
          if (action === "tooltip") {
              if ("column" in component && "definition" in component.column) {
                  tooltip = component.column.definition.tooltip;
              }
          } else {
              if ("definition" in component && "headerTooltip" in component.definition) {
                  tooltip = component.definition.headerTooltip;
              }
          }
          //UPDATE end
