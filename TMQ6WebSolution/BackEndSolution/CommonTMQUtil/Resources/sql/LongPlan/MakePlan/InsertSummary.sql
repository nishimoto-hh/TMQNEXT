...
SELECT
    ...
    lp.location_district_structure_id,
    lp.location_factory_structure_id,
    lp.location_plant_structure_id,
    lp.location_series_structure_id,
    lp.location_stroke_structure_id,
    lp.location_facility_structure_id,
    lp.job_kind_structure_id,
