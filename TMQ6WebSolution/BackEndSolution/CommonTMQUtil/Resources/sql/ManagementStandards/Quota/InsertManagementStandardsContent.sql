...
VALUES(
    ...
    @InspectionContentStructureId,                                                      -- 点検内容ID
    @InspectionSiteImportanceStructureId,                                               -- 部位重要度ID
    @InspectionSiteConservationStructureId,                                             -- 部位保全方式ID
    @MaintainanceDivision,                                                              -- 保全区分ID
    @MaintainanceKindStructureId,                                                       -- 点検種別ID
    @BudgetAmount,                                                                      -- 予算金額
    @PreparationPeriod,                                                                 -- 準備期間(日)
    @LongPlanId,                                                                        -- 長計件名ID
    @OrderNo,                                                                           -- 並び順
    @ScheduleTypeStructureId,                                                           -- スケジュール管理基準ID
