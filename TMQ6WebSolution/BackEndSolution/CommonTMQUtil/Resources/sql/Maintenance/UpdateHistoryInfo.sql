...
SET
    ...
    , history_importance_structure_id = @HistoryImportanceStructureId        --重要度20231026AEC shiraishi
    , history_conservation_structure_id = @HistoryConservationStructureId      --保全方式20231026AEC shiraishi
