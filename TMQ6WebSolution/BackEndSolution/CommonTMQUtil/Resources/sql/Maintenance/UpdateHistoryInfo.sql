...
SET
    ...
    , history_importance_structure_id = @HistoryImportanceStructureId        --åÃè·éûä‘20231026AEC shiraishi
    , history_conservation_structure_id = @HistoryConservationStructureId      --åÃè·ã@äÌ20231026AEC shiraishi
