INSERT 
INTO mc_maintainance_schedule_detail(
...
OUTPUT inserted.maintainance_schedule_detail_id
VALUES ( 
    NEXT VALUE FOR seq_mc_maintainance_schedule_detail_maintainance_schedule_detail_id -- スケジュール詳細id
