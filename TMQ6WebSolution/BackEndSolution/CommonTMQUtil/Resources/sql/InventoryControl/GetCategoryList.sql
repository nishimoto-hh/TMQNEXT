...
SELECT DISTINCT
    ...
    , pih.inout_quantity AS transfer_count_value--受払数(帳票用)
    , pl.lot_no                                 --ロットNo
    , pl.unit_price                             --入庫金額
    , pl.unit_price AS unit_price_value         --入庫金額
    , pih.inout_quantity * pl.unit_price AS transfer_amount       --移庫金額
    , pih.inout_quantity * pl.unit_price AS transfer_amount_value --移庫金額
