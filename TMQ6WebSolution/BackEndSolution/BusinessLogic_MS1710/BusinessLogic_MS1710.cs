...
namespace BusinessLogic_MS1710
{
    /// <summary>
    /// 添付種類マスタ
    /// </summary>
    public class BusinessLogic_MS1710 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1710;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1710() : base()
        {
        }
        #endregion
