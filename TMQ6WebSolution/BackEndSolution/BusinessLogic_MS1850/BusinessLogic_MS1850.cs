...
namespace BusinessLogic_MS1850
{
    /// <summary>
    /// MQ分類マスタ
    /// </summary>
    public class BusinessLogic_MS1850 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1850;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1850() : base()
        {
        }
        #endregion
