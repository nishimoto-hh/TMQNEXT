    ...
    public class BusinessLogic_MS1740 : CommonBusinessLogicBase
    {
        ...
        private bool executeCheckAndRegistExcelPort(ref List<TMQUtil.CommonExcelPortMasterList> resultList, ref List<ComDao.UploadErrorInfo> errorInfoList)
        {
            ...
            bool isErrorExcelPort(TMQUtil.CommonExcelPortMasterList registInfo, ref List<ComDao.UploadErrorInfo> errorInfoList)
            {
                ...
                {
                    // 金額管理単位は既に登録されています。
                    errorInfoList.Add(TMQUtil.setTmpErrorInfo((int)registInfo.RowNo, ExcelPortMasterListInfo.ExData1ColumnNo, GetResMessage(new string[] { ComRes.ID.ID111070042 }), GetResMessage(new string[] { ComRes.ID.ID941260001, ComRes.ID.ID111070042 }), TMQUtil.ComReport.LongitudinalDirection, registInfo.ProcessId.ToString()));
                    return true;
                }
