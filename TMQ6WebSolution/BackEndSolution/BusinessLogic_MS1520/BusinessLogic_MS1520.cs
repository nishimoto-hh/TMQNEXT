...
namespace BusinessLogic_MS1520
{
    /// <summary>
    /// 故障性格要因マスタ
    /// </summary>
    public class BusinessLogic_MS1520 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1520;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1520() : base()
        {
        }
        #endregion
