...
namespace BusinessLogic_MS2140
{
    /// <summary>
    /// 変更管理メール送信情報マスタ
    /// </summary>
    public class BusinessLogic_MS2140 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2140;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2140() : base()
        {
        }
        #endregion
