...
namespace BusinessLogic_MS1290
{
    /// <summary>
    /// 作業目的マスタ
    /// </summary>
    public class BusinessLogic_MS1290 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1290;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1290() : base()
        {
        }
        #endregion
