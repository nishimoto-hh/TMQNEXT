...
namespace BusinessLogic_MS1420
{
    /// <summary>
    /// 依頼部課係マスタ
    /// </summary>
    public class BusinessLogic_MS1420 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1420;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1420() : base()
        {
        }
        #endregion
