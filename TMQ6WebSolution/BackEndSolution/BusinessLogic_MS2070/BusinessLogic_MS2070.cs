...
namespace BusinessLogic_MS2070
{
    /// <summary>
    /// 工場毎会計提出表出力条件マスタ
    /// </summary>
    public class BusinessLogic_MS2070 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2070;

        /// <summary>
        /// 拡張項目件数
        /// </summary>
        private static int itemExCnt = 2;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2070() : base()
        {
        }
        #endregion
