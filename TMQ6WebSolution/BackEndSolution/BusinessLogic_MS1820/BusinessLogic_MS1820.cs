...
namespace BusinessLogic_MS1820
{
    /// <summary>
    /// 対策分類Ⅰマスタ
    /// </summary>
    public class BusinessLogic_MS1820 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1820;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1820() : base()
        {
        }
        #endregion
