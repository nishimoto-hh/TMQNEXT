...
namespace BusinessLogic_MS1610
{
    /// <summary>
    /// 文書種類_機器台帳_機器添付マスタ
    /// </summary>
    public class BusinessLogic_MS1610 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1610;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1610() : base()
        {
        }
        #endregion
