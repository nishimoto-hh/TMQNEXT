...
namespace BusinessLogic_MS1640
{
    /// <summary>
    /// 文書種類_件名別長期計画_件名添付マスタ
    /// </summary>
    public class BusinessLogic_MS1640 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1640;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1640() : base()
        {
        }
        #endregion
