...
namespace BusinessLogic_MS2080
{
    /// <summary>
    /// 長期計画メール送信情報マスタ
    /// </summary>
    public class BusinessLogic_MS2080 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2080;

        /// <summary>
        /// 拡張項目件数
        /// </summary>
        private static int itemExCnt = 9;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2080() : base()
        {
        }
        #endregion
