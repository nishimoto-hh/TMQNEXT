...
namespace BusinessLogic_MS1660
{
    /// <summary>
    /// 文書種類_保全活動_故障分析_略図添付マスタ
    /// </summary>
    public class BusinessLogic_MS1660 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1660;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1660() : base()
        {
        }
        #endregion
