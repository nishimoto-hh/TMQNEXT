...
namespace BusinessLogic_MS1310
{
    /// <summary>
    /// 処置区分マスタ
    /// </summary>
    public class BusinessLogic_MS1310 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1310;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1310() : base()
        {
        }
        #endregion
