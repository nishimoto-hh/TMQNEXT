...
namespace BusinessLogic_MS1140
{
    /// <summary>
    /// 実績結果マスタ
    /// </summary>
    public class BusinessLogic_MS1140 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1140;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1140() : base()
        {
        }
        #endregion
