...
namespace BusinessLogic_MS1300
{
    /// <summary>
    /// 予算管理区分マスタ
    /// </summary>
    public class BusinessLogic_MS1300 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1300;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1300() : base()
        {
        }
        #endregion
