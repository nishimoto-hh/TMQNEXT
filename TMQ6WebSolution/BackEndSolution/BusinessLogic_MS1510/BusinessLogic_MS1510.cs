...
namespace BusinessLogic_MS1510
{
    /// <summary>
    /// 故障現象マスタ
    /// </summary>
    public class BusinessLogic_MS1510 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1510;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1510() : base()
        {
        }
        #endregion
