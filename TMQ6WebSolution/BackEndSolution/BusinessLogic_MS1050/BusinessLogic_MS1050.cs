...
namespace BusinessLogic_MS1050
{
    /// <summary>
    /// 処置対策マスタ
    /// </summary>
    public class BusinessLogic_MS1050 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1050;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1050() : base()
        {
        }
        #endregion
        ...
        private bool executeExcelPortRegist(TMQUtil.CommonExcelPortMasterList result, DateTime now)
        {
            // 登録処理
            // テーブル共通項目を設定
            setExecuteConditionByDataClassCommon(ref result, now, int.Parse(this.UserId), int.Parse(this.UserId));
