...
namespace BusinessLogic_MS1980
{
    /// <summary>
    /// 予備品出庫区分マスタ
    /// </summary>
    public class BusinessLogic_MS1980 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1980;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1980() : base()
        {
        }
        #endregion
