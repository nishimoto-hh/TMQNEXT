        ...
        protected override int ReportImpl()
        {
            ...
            switch (this.CtrlId)
            {
                case Button.Output:
                    ...
                    reportFactoryId = TMQUtil.IsExistsFactoryReportDefine(int.Parse(this.FactoryId), this.PgmId, ReportDefine.ReportIdMQActualResults, this.db) ? int.Parse(this.FactoryId) : 0;
