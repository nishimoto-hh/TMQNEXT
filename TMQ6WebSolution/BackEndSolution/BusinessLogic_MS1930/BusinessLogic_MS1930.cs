...
namespace BusinessLogic_MS1930
{
    /// <summary>
    /// 保全部課係マスタ
    /// </summary>
    public class BusinessLogic_MS1930 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1930;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1930() : base()
        {
        }
        #endregion
