...
namespace BusinessLogic_MS1210
{
    /// <summary>
    /// 使用区分マスタ
    /// </summary>
    public class BusinessLogic_MS1210 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1210;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1210() : base()
        {
        }
        #endregion
