...
namespace BusinessLogic_MS1670
{
    /// <summary>
    /// 文書種類_保全活動_故障分析_故障原因分析書添付マスタ
    /// </summary>
    public class BusinessLogic_MS1670 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1670;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1670() : base()
        {
        }
        #endregion
