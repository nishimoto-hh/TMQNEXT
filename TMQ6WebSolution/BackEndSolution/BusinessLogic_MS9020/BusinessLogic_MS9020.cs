...
namespace BusinessLogic_MS9020
{
    /// <summary>
    /// 言語マスタ
    /// </summary>
    public class BusinessLogic_MS9020 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 9020;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS9020() : base()
        {
        }
        #endregion
