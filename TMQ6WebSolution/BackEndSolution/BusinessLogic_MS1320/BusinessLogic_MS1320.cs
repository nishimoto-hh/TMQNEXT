...
namespace BusinessLogic_MS1320
{
    /// <summary>
    /// 設備区分マスタ
    /// </summary>
    public class BusinessLogic_MS1320 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1320;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1320() : base()
        {
        }
        #endregion
