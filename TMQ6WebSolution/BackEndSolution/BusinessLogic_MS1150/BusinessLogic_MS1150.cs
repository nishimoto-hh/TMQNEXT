...
namespace BusinessLogic_MS1150
{
    /// <summary>
    /// メーカーマスタ
    /// </summary>
    public class BusinessLogic_MS1150 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1150;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1150() : base()
        {
        }
        #endregion
