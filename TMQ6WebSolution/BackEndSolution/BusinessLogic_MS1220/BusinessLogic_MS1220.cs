...
namespace BusinessLogic_MS1220
{
    /// <summary>
    /// 保全項目(点検内容)マスタ
    /// </summary>
    public class BusinessLogic_MS1220 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1220;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1220() : base()
        {
        }
        #endregion
