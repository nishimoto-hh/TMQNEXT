...
namespace BusinessLogic_MS1230
{
    /// <summary>
    /// 保全区分マスタ
    /// </summary>
    public class BusinessLogic_MS1230 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1230;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1230() : base()
        {
        }
        #endregion
