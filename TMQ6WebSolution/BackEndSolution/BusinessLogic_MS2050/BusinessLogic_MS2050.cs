...
namespace BusinessLogic_MS2050
{
    /// <summary>
    /// 丸め処理区分マスタ
    /// </summary>
    public class BusinessLogic_MS2050 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2050;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2050() : base()
        {
        }
        #endregion
