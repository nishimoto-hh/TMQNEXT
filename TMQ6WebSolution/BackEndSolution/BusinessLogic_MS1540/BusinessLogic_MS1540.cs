...
namespace BusinessLogic_MS1540
{
    /// <summary>
    /// 依頼番号採番パターンマスタ
    /// </summary>
    public class BusinessLogic_MS1540 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1540;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1540() : base()
        {
        }
        #endregion
