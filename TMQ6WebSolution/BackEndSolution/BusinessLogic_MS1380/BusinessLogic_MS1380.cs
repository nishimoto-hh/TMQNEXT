...
namespace BusinessLogic_MS1380
{
    /// <summary>
    /// 修繕費分類マスタ
    /// </summary>
    public class BusinessLogic_MS1380 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1380;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1380() : base()
        {
        }
        #endregion
