...
namespace BusinessLogic_MS1080
{
    /// <summary>
    /// 発見方法マスタ
    /// </summary>
    public class BusinessLogic_MS1080 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1080;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1080() : base()
        {
        }
        #endregion
