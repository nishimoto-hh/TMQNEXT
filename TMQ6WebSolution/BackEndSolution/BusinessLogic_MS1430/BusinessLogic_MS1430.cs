...
namespace BusinessLogic_MS1430
{
    /// <summary>
    /// 工事区分マスタ
    /// </summary>
    public class BusinessLogic_MS1430 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1430;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1430() : base()
        {
        }
        #endregion
