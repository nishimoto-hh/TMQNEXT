...
namespace BusinessLogic_MS2040
{
    /// <summary>
    /// 予備品発注基準判定条件マスタ
    /// </summary>
    public class BusinessLogic_MS2040 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2040;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2040() : base()
        {
        }
        #endregion
