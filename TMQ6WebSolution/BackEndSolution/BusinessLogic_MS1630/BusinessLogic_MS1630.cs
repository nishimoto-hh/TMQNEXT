...
namespace BusinessLogic_MS1630
{
    /// <summary>
    /// 文書種類_機器台帳_MP情報タブマスタ
    /// </summary>
    public class BusinessLogic_MS1630 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1630;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1630() : base()
        {
        }
        #endregion
