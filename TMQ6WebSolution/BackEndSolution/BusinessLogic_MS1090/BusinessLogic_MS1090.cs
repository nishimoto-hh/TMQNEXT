...
namespace BusinessLogic_MS1090
{
    /// <summary>
    /// 変更管理マスタ
    /// </summary>
    public class BusinessLogic_MS1090 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1090;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1090() : base()
        {
        }
        #endregion
