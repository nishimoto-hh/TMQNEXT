...
namespace BusinessLogic_MS1410
{
    /// <summary>
    /// 作業区分マスタ
    /// </summary>
    public class BusinessLogic_MS1410 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1410;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1410() : base()
        {
        }
        #endregion
