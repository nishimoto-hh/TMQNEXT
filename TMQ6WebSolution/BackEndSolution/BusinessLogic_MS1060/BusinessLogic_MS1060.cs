...
namespace BusinessLogic_MS1060
{
    /// <summary>
    /// 予算性格区分マスタ
    /// </summary>
    public class BusinessLogic_MS1060 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1060;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1060() : base()
        {
        }
        #endregion
