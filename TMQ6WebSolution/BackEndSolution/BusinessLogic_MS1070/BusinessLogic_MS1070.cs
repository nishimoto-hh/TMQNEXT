...
namespace BusinessLogic_MS1070
{
    /// <summary>
    /// 緊急度マスタ
    /// </summary>
    public class BusinessLogic_MS1070 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1070;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1070() : base()
        {
        }
        #endregion
