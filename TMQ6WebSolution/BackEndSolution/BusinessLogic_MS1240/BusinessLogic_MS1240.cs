...
namespace BusinessLogic_MS1240
{
    /// <summary>
    /// 点検種別マスタ
    /// </summary>
    public class BusinessLogic_MS1240 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1240;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1240() : base()
        {
        }
        #endregion
