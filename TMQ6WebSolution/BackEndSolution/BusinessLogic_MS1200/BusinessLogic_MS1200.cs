...
namespace BusinessLogic_MS1200
{
    /// <summary>
    /// 重要度マスタ
    /// </summary>
    public class BusinessLogic_MS1200 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1200;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1200() : base()
        {
        }
        #endregion
