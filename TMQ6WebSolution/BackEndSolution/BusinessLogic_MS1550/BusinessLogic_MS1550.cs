...
namespace BusinessLogic_MS1550
{
    /// <summary>
    /// 作業／故障区分マスタ
    /// </summary>
    public class BusinessLogic_MS1550 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1550;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1550() : base()
        {
        }
        #endregion
