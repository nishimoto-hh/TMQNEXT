...
namespace BusinessLogic_MS1700
{
    /// <summary>
    /// 文書種類_予備品一覧_画像添付マスタ
    /// </summary>
    public class BusinessLogic_MS1700 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1700;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1700() : base()
        {
        }
        #endregion
