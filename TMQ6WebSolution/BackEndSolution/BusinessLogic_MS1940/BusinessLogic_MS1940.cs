...
namespace BusinessLogic_MS1940
{
    /// <summary>
    /// 新旧区分マスタ
    /// </summary>
    public class BusinessLogic_MS1940 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1940;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1940() : base()
        {
        }
        #endregion
