        ...
        protected override int ReportImpl()
        {
            ...
            switch (this.CtrlId)
            {
                ...
                case ConductInfo.FormList.Button.OutputCsv:
                    ...
                    //reportFactoryId = TMQUtil.IsExistsFactoryReportDefine(int.Parse(this.FactoryId), this.PgmId, UploadFile.ReportId, this.db) ? int.Parse(this.FactoryId) : 0;
                    ...
                    //        // 対象リストからデータを取得
                    //        dataList = getDataListByResultInfoDictionary(ConductInfo.FormList.List.InventoryList);
            ...
            //                Dao.searchInventoryResult formData = new();
