...
namespace BusinessLogic_MS1690
{
    /// <summary>
    /// 文書種類_保全活動_故障分析(個別工場)_故障原因分析書添付マスタ
    /// </summary>
    public class BusinessLogic_MS1690 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1690;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1690() : base()
        {
        }
        #endregion
