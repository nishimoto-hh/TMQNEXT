...
namespace BusinessLogic_MS1280
{
    /// <summary>
    /// 作業項目マスタ
    /// </summary>
    public class BusinessLogic_MS1280 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1280;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1280() : base()
        {
        }
        #endregion
