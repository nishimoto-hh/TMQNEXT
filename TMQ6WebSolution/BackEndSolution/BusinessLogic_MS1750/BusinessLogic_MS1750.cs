...
namespace BusinessLogic_MS1750
{
    /// <summary>
    /// 文書種類_予備品一覧_文書添付マスタ
    /// </summary>
    public class BusinessLogic_MS1750 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1750;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1750() : base()
        {
        }
        #endregion
