...
namespace BusinessLogic_MS1650
{
    /// <summary>
    /// 文書種類_保全活動_件名添付マスタ
    /// </summary>
    public class BusinessLogic_MS1650 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1650;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1650() : base()
        {
        }
        #endregion
