...
namespace BusinessLogic_MS1680
{
    /// <summary>
    /// 文書種類_保全活動_故障分析(個別工場)_略図添付マスタ
    /// </summary>
    public class BusinessLogic_MS1680 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1680;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1680() : base()
        {
        }
        #endregion
