...
namespace BusinessLogic_MS1600
{
    /// <summary>
    /// 文書種類_機器台帳_機番添付マスタ
    /// </summary>
    public class BusinessLogic_MS1600 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1600;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1600() : base()
        {
        }
        #endregion
