...
namespace BusinessLogic_MS1830
{
    /// <summary>
    /// 対策分類Ⅱマスタ
    /// </summary>
    public class BusinessLogic_MS1830 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1830;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1830() : base()
        {
        }
        #endregion
