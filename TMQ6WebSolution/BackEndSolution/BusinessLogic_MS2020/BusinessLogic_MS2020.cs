...
namespace BusinessLogic_MS2020
{
    /// <summary>
    /// 工場毎年度期首月マスタ
    /// </summary>
    public class BusinessLogic_MS2020 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2020;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2020() : base()
        {
        }
        #endregion
        ...
        private bool isErrorExclusive()
        {
            ...
            // 工場アイテムのみのため、工場別未使用標準アイテムマスタの排他チェックはなし
