...
namespace BusinessLogic_MS1330
{
    /// <summary>
    /// 時期マスタ
    /// </summary>
    public class BusinessLogic_MS1330 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1330;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1330() : base()
        {
        }
        #endregion
