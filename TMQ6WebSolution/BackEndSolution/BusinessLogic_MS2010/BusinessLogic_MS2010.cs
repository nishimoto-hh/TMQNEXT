...
namespace BusinessLogic_MS2010
{
    /// <summary>
    /// 棚卸時間マスタ
    /// </summary>
    public class BusinessLogic_MS2010 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 2010;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS2010() : base()
        {
        }
        #endregion
