...
namespace BusinessLogic_MS1570
{
    /// <summary>
    /// 環境安全管理区分マスタ
    /// </summary>
    public class BusinessLogic_MS1570 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1570;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1570() : base()
        {
        }
        #endregion
