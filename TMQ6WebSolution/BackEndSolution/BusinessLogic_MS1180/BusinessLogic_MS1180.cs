...
namespace BusinessLogic_MS1180
{
    /// <summary>
    /// 部位マスタ
    /// </summary>
    public class BusinessLogic_MS1180 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1180;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1180() : base()
        {
        }
        #endregion
