...
namespace BusinessLogic_MS1560
{
    /// <summary>
    /// 故障分析マスタ
    /// </summary>
    public class BusinessLogic_MS1560 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1560;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1560() : base()
        {
        }
        #endregion
