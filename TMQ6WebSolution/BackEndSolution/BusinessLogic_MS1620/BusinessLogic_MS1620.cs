...
namespace BusinessLogic_MS1620
{
    /// <summary>
    /// 文書種類_機器台帳_保全項目一覧マスタ
    /// </summary>
    public class BusinessLogic_MS1620 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1620;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1620() : base()
        {
        }
        #endregion
