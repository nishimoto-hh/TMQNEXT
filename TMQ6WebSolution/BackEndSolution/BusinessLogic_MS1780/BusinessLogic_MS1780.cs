...
namespace BusinessLogic_MS1780
{
    /// <summary>
    /// 文書種類_予備品一覧_予備品地図マスタ
    /// </summary>
    public class BusinessLogic_MS1780 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1780;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1780() : base()
        {
        }
        #endregion
