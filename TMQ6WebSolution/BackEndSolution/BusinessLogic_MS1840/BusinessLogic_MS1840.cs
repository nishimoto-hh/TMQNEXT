...
namespace BusinessLogic_MS1840
{
    /// <summary>
    /// 点検種別毎管理(機器別管理基準)工場マスタ
    /// </summary>
    public class BusinessLogic_MS1840 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1840;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1840() : base()
        {
        }
        #endregion
