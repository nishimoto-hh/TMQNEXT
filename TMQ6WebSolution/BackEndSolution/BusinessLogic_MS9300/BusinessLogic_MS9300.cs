...
namespace BusinessLogic_MS9300
{
    /// <summary>
    /// ファイルアップロード不可拡張子マスタ
    /// </summary>
    public class BusinessLogic_MS9300 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 9300;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS9300() : base()
        {
        }
        #endregion
