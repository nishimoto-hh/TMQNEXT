...
namespace BusinessLogic_MS1030
{
    /// <summary>
    /// 保全方式マスタ
    /// </summary>
    public class BusinessLogic_MS1030 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1030;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1030() : base()
        {
        }
        #endregion
