...
namespace BusinessLogic_MS1100
{
    /// <summary>
    /// 環境安全管理マスタ
    /// </summary>
    public class BusinessLogic_MS1100 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1100;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1100() : base()
        {
        }
        #endregion
