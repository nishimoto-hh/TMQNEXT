...
namespace BusinessLogic_MS1470
{
    /// <summary>
    /// 故障性格分類マスタ
    /// </summary>
    public class BusinessLogic_MS1470 : CommonBusinessLogicBase
    {
        #region 定数
        /// <summary>
        /// 構成グループID
        /// </summary>
        private static int structureGroupId = 1470;
        ...
        /// コンストラクタ
        /// </summary>
        public BusinessLogic_MS1470() : base()
        {
        }
        #endregion
