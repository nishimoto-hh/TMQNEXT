...
select st.factory_id as factoryId,
  ...
  from v_structure_item_all AS st
       left outer join ms_item_extension as item_ex on (st.structure_item_id=item_ex.item_id and item_ex.sequence_no=/*param3*/0) 
       /*IF factoryIdList != null && factoryIdList.Count > 0*/
       -- 工場ごとに工場別表示順を取得する
...
/*IF param4 != null && param4 != ''*/
   and item_ex.extension_data not in /*param4*/(0)
/*END*/
