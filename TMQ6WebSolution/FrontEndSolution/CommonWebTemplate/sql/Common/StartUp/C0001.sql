 ...
 * C0002、C0031はこのSQLの拡張なので横並びで対応すること
 */
-- C0001
-- 構成マスタ内の全工場
WITH factory AS(
...
SELECT 
    ...
    ,st.item_translation_id AS translationId
...
AND ((conditions.param2 IS NULL OR conditions.param2 = '') OR st.structure_layer_no = conditions.param2)
