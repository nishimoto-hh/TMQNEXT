...
(function ($, undefined) {
    ...
    $.extend(Ympicker.prototype, {
        ...
        _showYmpicker: function (input) {
            ...
            if (isFixed) { // ATTS JUqyerのバージョンが古い
        ...
        _generateHTML: function (inst) {
            ...
            // サンプルプログラムのJqueryのバージョンが古い ATTS
            // html += buttonPanel + ($.browser.msie && parseInt($.browser.version,10) < 7 && !inst.inline ?
            html += buttonPanel + ($.support.opacity && parseInt($.support.version, 10) < 7 && !inst.inline ?
    ...
    function isArray(a) {
        /* ATTS JQueryのバージョンが古い
        return (a && (($.browser.safari && typeof a == 'object' && a.length) ||
            (a.constructor && a.constructor.toString().match(/\Array\(\)/))));
            */
        return (a && ((typeof a == 'object' && a.length) ||
            (a.constructor && a.constructor.toString().match(/\Array\(\)/))));
    };
